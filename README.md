...
- Make a server.js file and make sure to require all the modules. E.g. Express and bodyParser. Or use app.use(express.json()) app.use(express.urlencoded({ extended: false })) if you dont want to use body parser.

- Don't forget to listen with app.
...
You'll only need the `index.ejs` for this assessment - there's no need to create any other EJS views!
...
- If you're adding your own CSS dont to set your app to serve static content
